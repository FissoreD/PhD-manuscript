...
\begin{tikzpicture}[]
    ...
    % \draw [->] (t1) -- (t2)node[pos=1,xshift=1pt,yshift=2pt]{*} node[midway, above]{\runT'\ $t$};
    % \draw [->] (e1) -- (e2)node[pos=1,xshift=1pt,yshift=2pt]{*} node[midway, below]{\runS\ $a$};
    \draw [->] (t1) -- (t2) node[midway, above]{\runT'\ $t$};
    \draw [->] (e1) -- (e2) node[midway, below]{\runS\ $a$};
