...
weak-head normal form of \eI{~\oapp~ [F | L]}.
...
\noindent
This theorem states that if two terms can be unified in the source language,
...
\begin{figure}
  ...
  \begin{subfigure}{1\textwidth}    
    ...
    \vspace{-15pt}
    \caption{Recursive compilation on terms}
    \label{fig:comp-fo}
  \end{subfigure}
...
and is activated under specific conditions, in particular, whern \cref{inv:linklhs}
