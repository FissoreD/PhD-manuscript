...
\newcommand{\llambda}{EE}
\newcommand{\elpiIn}[1]{\eI{#1}}
\newcommand{\coqIn}[1]{\cI{#1}}
...
\newcommand{\appsep}{appsep}
\newcommand{\UnifRel}{UnifRel}
\newcommand{\EqualRel}{UnifRel}

\newcommand{\foUnifPb}{foUnifPb}
\newcommand{\hoUnifPb}{hoUnifPb}

\newcommand{\linkStore}{linkStore}
\newcommand{\mapStore}{mapStore}
\newcommand{\fullref}{fullref}
\newcommand{\Fullref}{Fullref}

\newcommand{\linketa}{linketa}
\newcommand{\linkbeta}{linkbeta}
\newcommand{\linkbetaM}{betaM}
\newcommand{\linketaM}{etaM}
...
the premise <<\elpiIn{link Pm A P}>> brings the assignment for \emph{Pm}
...
\begin{figure}[b] %[H]
  ...
  \begin{minipage}{0.5\textwidth}
    \includegraphics[width=1\textwidth]{HO-unif-for-free/img/fo_tm.pdf}
  \end{minipage}
  &
  \begin{minipage}{0.5\textwidth}
    \includegraphics[width=1\textwidth]{HO-unif-for-free/img/ho_tm.pdf}
  \end{minipage}
...
\fbox{%
  \begin{minipage}{1\textwidth}
    \includegraphics{HO-unif-for-free/img/feq.pdf}%
...
% \input{code/ue_type}
\includegraphics{HO-unif-for-free/img/ue_type.pdf}
...
\includegraphics{HO-unif-for-free/img/mem_types.pdf}
...
\includegraphics{HO-unif-for-free/img/ho_subst.pdf}
...
\includegraphics{HO-unif-for-free/img/comp_base_types.pdf}
...
\inlinefigure{%
\includegraphics{HO-unif-for-free/img/alloc_mapping.pdf}%
...
\includegraphics{HO-unif-for-free/img/deref.pdf}
...
\includegraphics{HO-unif-for-free/img/move.pdf}
...
\includegraphics{HO-unif-for-free/img/comp_links.pdf}
...
\fbox{%
  \begin{minipage}{1\textwidth}
    \includegraphics{HO-unif-for-free/img/comp_base.pdf}%
    \captionof{figure}{Comp FO}
    \label{fig:comp-fo}
  \end{minipage}
}

\includegraphics{HO-unif-for-free/img/compile.pdf}
...
\fbox{%
  \begin{minipage}{1\textwidth}
    \includegraphics{HO-unif-for-free/img/comp_lam.pdf}%
    \captionof{figure}{Comp FO}
    \label{fig:comp-lam}
  \end{minipage}
}
...
\includegraphics{HO-unif-for-free/img/comp_close_links.pdf}
...
\includegraphics{HO-unif-for-free/img/hstep.pdf}
...
\includegraphics{HO-unif-for-free/img/progress.pdf}
...
\includegraphics{HO-unif-for-free/img/unif_fo.pdf}
...
\includegraphics{HO-unif-for-free/img/comp_base_beta.pdf}
...
\includegraphics{HO-unif-for-free/img/comp_eta.pdf}
...
\includegraphics{HO-unif-for-free/img/comp_beta.pdf}
