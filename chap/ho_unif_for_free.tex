...
shown in \cref{code:common-terms}. Terms of \Fo{} are written as \eI{to}, while
terms of \Ho{} are written as \eI{tm}. These correspond, respectively, to
object-level terms and meta-level terms.

The main difference between these two representations lies in how variables are
encoded. Variables are associated with a memory address. In \Fo{}, variables are
first-order and do not carry any scope. In contrast, variables in \Ho{} include a
