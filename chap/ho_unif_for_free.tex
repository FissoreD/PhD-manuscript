...
\begin{proposition}\label{prop:xxx}
  ...
  $$
    ...
    t_1 \Ue t_2 \arr \sigma \label{prop:compilation-w}
  $$
\end{proposition}
...
\begin{theorem}[Fidelity in \wellb] \Cref{prop:simulation} and
...
\begin{theorem}[Fidelity in $\wellb_\beta$] \Cref{prop:simulation} and
