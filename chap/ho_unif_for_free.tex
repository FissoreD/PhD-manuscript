...
Rule $r_v$ is responsible for variables in the object language. It maps
them to meta-language variables by introducing a fresh entry in the
memory map and updating the substitution with a pointer for this fresh
variable. This pointer is initially set to \eI{none}. These operations
are delegated to the \eI{m-alloc} procedure, which performs the actual
allocation.
