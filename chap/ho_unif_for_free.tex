...
\noindent
Whenever \eI{~\olam~ F} is detected to be in
\maybeeta it is compiled to \eI{~\mlam~ F1} and replaced by the fresh
variable \eI{A}. This variable sees all the names free in
\eI{~\mlam~ F1} and is connected to \eI{~\mlam~ F1} via a \linketa.
\Cref{inv:linklhs} holds for this link. Moreover:
