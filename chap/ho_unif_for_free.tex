...
In the rule body, we have added a new higher-order \elpi variable \eI{Qm} which
...
called \Fo{} for object language and \Ho for the meta language. 
We detail the encoding of \Fo{} in \Ho, and we show that
...
Our encoding of \Fo and \Ho is given in the \elpi language. In
\cref{code:common-terms}, we provide in the syntax of the terms of \Fo, called
\eI{to} and the terms of \Ho, called \eI{tm}. As claimed before, our framework
...
\Ho, the variables have a scope which is represented as a list of term. We use
