...
Finally, the auxiliary function \eI{close-links} checks whether the
bound variables occur in a link. If this is the case, the link is
wrapped in an additional \eI{abs} node binding. In this way,
