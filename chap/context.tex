...
As a simple example, we choose the \texttt{Eqb} type class, parametrized by a
type \emph{'a} and containing the method \emph{eqb} allowing to test if two
objects of type \emph{'a} are equal. In \cref{fig:eqb-tc}, we give two
...
\begin{figure}
  ...
  \includegraphics{./code/base_tc.pdf}
  \caption{\texttt{Eqb} typeclass in Rocq}
  \label{fig:eqb-tc-coq}
  \end{subfigure}
  \begin{subfigure}{1\textwidth}
  \includegraphics{./code/base_tc_hs.pdf}
